...
class IchimokuSpanBStrategy(IStrategy):
    """
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
                ...
                (qtpylib.crossed_above(dataframe["close"], dataframe["ichimoku-spanB"]))
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
                ...
                (qtpylib.crossed_below(dataframe["close"], dataframe["ichimoku-spanB"]))
                & (dataframe["volume"] > 0)  # Make sure Volume is not 0
            ),
            "exit_long",
        ] = 1
