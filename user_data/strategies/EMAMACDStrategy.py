...
class EMAMACDStrategy(IStrategy):
    """
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
                # MACD is under zero and crossed above its signal line
                (dataframe['macd'] < self.macd_threshold.value) &
                # the macd line crossed above the signal line within the last X candles
                (dataframe['macd_cross_above_last_X']) &
