...
**Status:** 🔴 RED  
**Description:** Poor Performance (Median Profit: -0.62%, Profit Factor: 0.85)

---
            
**Strategy:** IchimokuKinjunStrategy  
**Random State:** 1479  
**Timestamp:** 2025-09-14 21:24:35
...
## Hyperopt Command
```bash
docker compose run --rm freqtrade hyperopt -j 8 --config /freqtrade/user_data/config.json --print-json --hyperopt-loss SharpeHyperOptLoss --strategy IchimokuKinjunStrategy --timeframe 1h --epochs 100 --spaces sell --pairs BTC/USDT ETH/USDT LTC/USDT XRP/USDT BNB/USDT --timerange 20170801-20191231 --random-state 1479
```
...
Best result:
    ...
    67/100:    643 trades. 124/0/519 Wins/Draws/Losses. Avg profit  -0.12%. Median profit  -0.62%. Total profit -257.85409094 USDT ( -25.79%). Avg duration 6:47:00 min. Objective: 0.54503
