...
## Hyperopt Command
```bash
docker compose run --rm freqtrade hyperopt -j 8 --config /freqtrade/user_data/config.json --print-json --hyperopt-loss SharpeHyperOptLoss --strategy IchimokuKinjunStrategy --timeframe 1h --epochs 100 --spaces sell --pairs BTC/USDT ETH/USDT LTC/USDT XRP/USDT BNB/USDT --timerange 20170801-20191231 --random-state 9898
```
...
Best result:
    ...
    38/100:     54 trades. 9/0/45 Wins/Draws/Losses. Avg profit  -0.29%. Median profit  -0.74%. Total profit -51.57713967 USDT (  -5.16%). Avg duration 9:49:00 min. Objective: 0.14838
